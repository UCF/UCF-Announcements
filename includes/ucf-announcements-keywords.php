<?php
/**
 * Handles registering the keywords custom taxonomy.
 **/
if ( ! class_exists( 'UCF_Keyword_Custom_Taxonomy' ) ) {
	class UCF_Keyword_Custom_Taxonomy
	 {
		public function register_taxonomy() {
			...
			register_taxonomy( 'keywords', array( 'announcement' ), self::args( $labels ) );
		}
